...
//    public static List<Map<String,String>> getStringListMap(List<Map<String, Object>> obj){
...
//    }
//
//    private static Map<String, String> getStringStringMap(Map<String, Object> obj, Map<String, String> result) {
//        if (obj != null) {
